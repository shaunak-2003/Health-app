...
import { loadColumns } from './configureRecommendationsCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';

const perPage = 10;

const TableSampleRecommendations = ({
  filterItems,
  setFilterItems,
  filters,
}) => {
  ...
  useEffect(() => {
    if (recommendationsNotify.showNotification) {
      notify(
        recommendationsNotify.typeNotification,
        recommendationsNotify.textNotification,
      );
    }
  }, [recommendationsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/recommendations/recommendations-view/?id=${id}`);
  };
...
export default TableSampleRecommendations;
